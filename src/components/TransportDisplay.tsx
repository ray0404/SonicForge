        ...
        <div className="flex-1 flex flex-col gap-1 min-w-0">
          ...
          <div className="relative h-6 group flex items-center">
             <input
              ...
              />
             {/* Custom Range Track */}
             <div className="absolute left-0 right-0 h-1.5 bg-slate-800 rounded-full overflow-hidden peer-focus-visible:ring-2 peer-focus-visible:ring-primary peer-focus-visible:ring-offset-2 peer-focus-visible:ring-offset-slate-900 transition-shadow">
                 <div
