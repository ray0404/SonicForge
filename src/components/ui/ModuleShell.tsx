      ...
      <div className="flex items-center justify-between px-3 py-2 bg-slate-950 border-b border-slate-800">
        <div className="flex items-center gap-2">
           ...
           <button
             ...
             aria-label={isBypassed ? "Activate module" : "Bypass module"}
             className={clsx(
        ...
        <button
          ...
          className="text-slate-600 hover:text-red-500 transition-colors opacity-0 group-hover:opacity-100 focus:opacity-100 focus:text-red-500"
          title="Remove Module"
        >
          <X size={16} />
        </button>
