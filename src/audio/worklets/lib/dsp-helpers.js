...
/**
 * Linear to DB constant (20 / ln(10))
 */
export const LINEAR_TO_DB_CONST = 8.685889638065035; // 20 / Math.LN10

/**
 * Converts Linear gain factor to Decibels.
 * Optimized using Math.log() and precomputed constant.
