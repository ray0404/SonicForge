...
## 2024-05-24 - Focus Visibility on Hover-Only Actions
**Learning:** Interactive elements hidden by default (e.g., `opacity-0`) and revealed on hover (`group-hover:opacity-100`) are invisible to keyboard users.
**Action:** Always pair hover-reveal classes with focus-reveal classes (e.g., `focus:opacity-100`) to ensuring keyboard users can discover and interact with them.
